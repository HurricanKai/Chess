...
public final class MainMenuButtonElement extends ButtonElement
{
    ...
    {
        graphics.drawRoundRect(x, y, width, height, new AbsoluteSize(25), new AbsoluteSize(25), new Color(237, 216, 191));
        graphics.drawString(title, x, y, width, height, Anchor.CENTER, Anchor.CENTER, Color.BLACK, new Font("Courier New", Font.PLAIN, 36));
    }
